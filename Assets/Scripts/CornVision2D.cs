...
public class CornVision2D : MonoBehaviour
{
    ...
    {
        Vector3 direction = DirectionFromAngle2D(angle, 0f);
    ...
    public Vector3 DirectionFromAngle2D(float angle, float additionalAngle)
    {
